...
public class ApplicationUtil {
    ...
    public static String getAppName() {
        try {
            PackageManager e = ApplicationUtil.INSTANCE.getPackageManager();
            PackageInfo packageInfo = e.getPackageInfo(ApplicationUtil.INSTANCE.getPackageName(), 0);
            int labelRes = packageInfo.applicationInfo.labelRes;
            return ApplicationUtil.INSTANCE.getResources().getString(labelRes);
